...
ACCESS_TOKEN = os.getenv("LINE_ACCESS_TOKEN", "k/S6FyZxj1t+TkORqMbLgF3FF3Hd3HjsFK/sEIiYxxStgamw+oGbYspMWSGbNer0vR2zQQc1Kw5mGqL2Co7hcqHj+ry/kAydzV9gQ80j3rw71vnx0HZmVh8GC3RCxhTqdLlVzx6OyQRfu/bKmF842wdB04t89/1O/w1cDnyilFU=")
CHANNEL_SECRET = os.getenv("LINE_CHANNEL_SECRET", "b2a2a409f73ecfbbbd166c3b64ea5abb")

# ข้อมูล Gemini api key
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyDiiXuZ-Bjo_4z1hYfIDTCWMNKXr7NGkaw")
...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "อิมิว ทำไร คือ นิสิตที่เรียนอยู่มอบูรพาเรียนสาขา CS",
        "อิมิว ทำไร มีชื่อเล่นว่า มิว เกิดวันที่ 13 มกราคม 2546 ที่จังหวัดชลบุรี กำลังศึกษามหาวิทยาลัยบูรพา สาขาวิทยาการคอมพิวเตอร์",
        "งาน BUU-Bootcamp-2024 จัดที่มหาวิทยาลัยบูรพา ในวันที่ 25 มกราคม ปีค.ศ.2024 โดยมีการจัดกิจกรรมต่าง ๆ ที่เกี่ยวข้องกับการพัฒนาซอฟต์แวร์ เวลา 9:00 น. - 16:00 น. คนเข้าร่วม 250 คน",
        "มหาวิทยาลัยบูรพา สาขาวิชาAI ปีการศึกษา 2565 มีนักศึกษาจำนวน 100 คน มีอาจารย์ที่ปรึกษา 10 คน",
        "ClickNext team AI มีใครบ้าง พี่ออย ทำหน้าที่ BA พี่ดาว ทำหน้าที่ BA พี่เจ๋ง ทำหน้าที่ Frontend พี่ปาล์ม ทำหน้าที่ Backend พี่ชวน ทำหน้าที่ Data Operator"
    ]
